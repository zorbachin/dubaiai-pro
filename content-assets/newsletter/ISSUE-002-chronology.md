...
## How it lays out (the cinematic treatment)
- A vertical **timeline**: year/era on the left, each beat a "scene."
- Each scene = a still/thumbnail + 1-2 honest sentences + the embedded video/site.
- Framing: *"I didn't plan a portfolio. I made one call, and kept following the problem."*
- Ends on the invitation (same as Issue 001): make your first call/post.

## What I'll do once you fill the slots
1. Write the connective tissue between beats (in your voice).
2. Build a cinematic **timeline graphic** (like the masthead) for the email/site.
3. Lay out Issue 002 with the embeds, ready to paste into Substack.
