...
- **Last commit:** ef29feb feat: brain-dump parser — raw dumps to flywheel content — 50 seconds ago
...
**Recent commits:**
```
ef29feb feat: brain-dump parser — raw dumps to flywheel content (50 seconds ago)
...
686819c Comms style + anti-splinter home rule (stay in Claude) (#21) (15 minutes ago)
```
<!-- AUTOSTATE:END -->
