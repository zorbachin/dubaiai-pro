      ...
      >
        ...
        <div className="relative flex flex-wrap items-start justify-between gap-6">
          ...
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-4 py-2.5 text-sm text-[color:var(--color-ink-dim)] transition hover:bg-white/[0.08] hover:text-white">
            ...
            <button
              className="flex items-center gap-2 rounded-xl border border-rose-400/20 bg-rose-400/10 px-4 py-2.5 text-sm text-rose-200 transition hover:bg-rose-400/20"
              title="Decommission"
            >
